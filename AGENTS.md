...
All on-screen graphics come from `videoai_graphics.broadcast` (the house "broadcast" system; House graphics section of PRODUCTION_RULES.md) regardless of subject; `Theme(subject=...)` only changes the accent.
